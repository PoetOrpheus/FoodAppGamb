package com.example.foodappgamb.Repository
...
class MainRepository {
    ...
    private val firebaseDatabase=FirebaseDatabase.getInstance("https://project-695140718909673780-default-rtdb.firebaseio.com/")
    ...
    fun loadFilterd(id:String):LiveData<MutableList<FoodModel>>{
